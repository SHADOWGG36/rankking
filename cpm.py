...
secret='shadowvip'
device_id='SHADOW'+hashlib.sha256((str(platform.release()) + str(platform.version()) + str(platform.machine()) + str(platform.node())).encode()).hexdigest()[:10].upper()
...
{do}║{luc}TikTok   :{vang} shadowgg_36
{do}╚═════════════════════════════════════════════════════
